// AxiStreamSdramWrapper.sv - Verzia 1.8 - Vylepšená robustnosť a laditeľnosť
// Modul, ktorý slúži ako most medzi AXI-Stream rozhraním a SDRAM kontrolérom.
// Zmeny:
// 1. VYLEPŠENIE: Zvýšený predvolený počet bufferov na 4 (Quad-Buffering) pre vyššiu priepustnosť.
// 2. PRIDANÉ (SVA): Doplnené SystemVerilog Assertions pre formálnu verifikáciu
//    správnosti stavov bufferov a zamedzenie chybám.
// 3. PRIDANÉ (Debug): Nové ladiace výstupy na sledovanie stavu každého buffera
//    a ukazovateľov round-robin schedulera. Riadené parametrom ENABLE_DEBUG.
...
module AxiStreamSdramWrapper #(
    ...
    parameter integer NUM_BUFFERS       = 4, // ZMENA (v1.8): Predvolene Quad-Buffering
    parameter logic   ENABLE_DEBUG      = 1, // PRIDANÉ (v1.8)
