// AxiStreamSdramWrapper.sv - Verzia 2.04 - Final Syntax Fix
// Modul, ktorý slúži ako most medzi AXI-Stream rozhraním a SDRAM kontrolérom.
// Zmeny (v2.04):
// 1. OPRAVA (Synthesis): Opravená systematická syntaktická chyba, kde bola
//    bodkočiarka nesprávne umiestnená vnútri apostrofov pri nulovaní
//    registrov (napr. `'0';` opravené na `'0;`).
//
// Zmeny (v2.03):
// 1. Viacnásobné priradenia na jednom riadku v resetovacej logike boli
//    rozdelené na samostatné riadky.
...
module AxiStreamSdramWrapper #(
    ...
    always_ff @(posedge clk) begin
        ...
        if (!rstn || internal_reset || soft_reset_i) begin
            ...
            // OPRAVA (v2.04): Všetky priradenia majú správnu syntax `'0;`
            write_ptr <= '0;
            read_ptr <= '0;
