// AxiStreamSdramWrapper.sv - Verzia 1.0
// Modul, ktorý slúži ako most medzi AXI-Stream rozhraním a SDRAM kontrolérom.
// Zapisuje paket dát z AXI-Stream vstupu do SDRAM a následne ho cyklicky číta
// a posiela na AXI-Stream výstup.
...
module AxiStreamSdramWrapper #(
    ...
    // Dĺžka burstu sa musí zhodovať s parametrom v inštancii SDRAM kontroléra
