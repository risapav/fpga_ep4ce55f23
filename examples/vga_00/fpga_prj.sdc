...
# pixel_clk
create_generated_clock -name pixel_clk -source [get_ports {SYS_CLK}] -multiply_by 54 -divide_by 25 [get_pins {clkpll_inst|altpll_component|auto_generated|pll1|clk[0]}]
