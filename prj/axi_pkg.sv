...
package axi_pkg;
    ...
    parameter int AXI_TDATA_WIDTH = 16; // Šírka TDATA v bitoch
    parameter int AXI_TUSER_WIDTH = 1;  // Šírka TUSER v bitoch
    ...
    typedef struct packed {
        ...
        logic [AXI_TUSER_WIDTH-1:0] TUSER;  // Používateľský signál s parametrizovateľnou šírkou
        logic [AXI_TDATA_WIDTH-1:0] TDATA;  // Dátová zbernica s parametrizovateľnou šírkou
    } axi4s_payload_t;
